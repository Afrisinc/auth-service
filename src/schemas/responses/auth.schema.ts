  ...
  properties: {
    ...
    data: {
      ...
      properties: {
        ...
        role_id: {
          type: 'string',
          description: 'User role ID (if user has organization membership)',
          nullable: true,
        },
        role: {
          type: 'string',
          description: 'User role name (e.g., SUPER_ADMIN, OPS_MANAGER)',
          nullable: true,
        },
      },
  ...
  properties: {
    ...
    data: {
      ...
      properties: {
        ...
        role: { type: 'string', description: 'User role, e.g. SUPER_ADMIN, OPS_MANAGER, member' },
        account_id: { type: 'string', description: 'Account ID, present on product-scoped tokens' },
        product: { type: 'string', description: 'Product code, present on product-scoped tokens' },
      },
